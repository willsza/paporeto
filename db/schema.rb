...
ActiveRecord::Schema.define(version: 20150203002441) do
  ...
  add_index "images", ["secure_random"], name: "index_images_on_secure_random"

  create_table "suggested_articles", force: :cascade do |t|
    t.string   "name"
    t.string   "email"
    t.text     "body"
